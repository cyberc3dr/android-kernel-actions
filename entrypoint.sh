...
if [[ $arch = "arm64" ]]; then
    ...
    toolchain_url="https://developer.arm.com/-/cdn-downloads/permalink/legacy-linaro-gnu-toolchains/7.4-2019.02/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu.tar.xz"
